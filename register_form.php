						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
									...
									<div class="form-group ">
                                        ...
                                        <input class="input form-control input-borders" type="text" name="m_name" id="f_name" placeholder="Middle Name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="address1" id="address1" placeholder="Address Line1">
                                    </div>
									<div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="address2" id="address2" placeholder="Address Line2">
                                    </div>
									<div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="city" id="city" placeholder="City">
                                    </div>
									<div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="state" id="state" placeholder="State">
                                    </div>
									...
									<div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="zipcode" id="zipcode" placeholder="Zipcode">
                                    </div>
