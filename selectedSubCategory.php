...
include "db.php";   
if(isset($_POST["get_seleted_Category"]) || isset($_POST["search"]) || isset($_POST["get_seleted_subCategory"])){
	if(isset($_POST["get_seleted_Category"])){
		$id = $_POST["cat_id"];
		$sql = "SELECT * FROM product WHERE subcategory_id = $id";
    }
    else{
	...
	//get the product when click to selected subcategory
